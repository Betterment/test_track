...
RSpec.describe Api::V2::BuildSplitRegistriesController, type: :controller do
  ...
  describe "#show" do
    ...
    it "returns empty with no active splits on the build_timestamp" do
    ...
    it "returns the full split registry of splits that are active during build_timestamp" do
      expect(split_1).to be_finished
    ...
    it "returns unprocessable_entity if the build_timestamp url param is invalid" do
      get :show, params: { build_timestamp: "2019-04-16 10:38:08 -0400" }

      expect(response).to have_http_status :unprocessable_entity
    end

    it "returns unprocessable_entity if the build_timestamp url param is missing" do
