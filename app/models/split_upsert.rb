class SplitUpsert
  ...
  attr_accessor :app, :name, :decided_at, :require_app_name_prefix
  attr_reader :weighting_registry

  validate :split_must_be_valid

  def save
    split.assign_attributes(finished_at: nil, decided_at: decided_at, require_app_name_prefix: require_app_name_prefix)
